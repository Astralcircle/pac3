...
surface.CreateFont("LuapadEditor", {font = system.IsLinux() and "DejaVu Sans" or "Tahoma", size = 16, weight = 400 } );
surface.CreateFont("LuapadEditor_Bold", {font = system.IsLinux() and "DejaVu Sans" or "Tahoma", size = 16, weight = 800});
